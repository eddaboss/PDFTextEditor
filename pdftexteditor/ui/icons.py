...
_ICONS: dict[str, tuple[str, bool]] = {
    ...
    # Top-mode icons (Lucide): Edit = document+pen, Form Fields = checkbox,
    # Fill Form = pen on a line.
    'mode_edit': ('<path d="M12.5 22H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v10"/> <path d="M14 2v4a2 2 0 0 0 2 2h4"/> <path d="M10.4 12.6a2 2 0 0 1 3 3L8 21l-4 1 1-4Z"/>', False),
    'mode_form_fields': ('<path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h9.344"/> <path d="m9 11 3 3L22 4"/>', False),
    'mode_fill_form': ('<path d="M13 21h8"/> <path d="m15 5 4 4"/> <path d="M18.4 2.6a2.17 2.17 0 0 1 3 3L6 21l-4 1 1-4Z"/>', False),
    'field_add': ('<rect width="18" height="18" x="3" y="3" rx="2"/> <path d="M12 8v8"/> <path d="M8 12h8"/>', False),
    'calendar': ('<path d="M8 2v4"/> <path d="M16 2v4"/> <rect width="18" height="18" x="3" y="4" rx="2"/> <path d="M3 10h18"/>', False),
    'check_square': ('<rect width="18" height="18" x="3" y="3" rx="2"/> <path d="m9 12 2 2 4-4"/>', False),
    'fields_list': ('<line x1="8" x2="21" y1="6" y2="6"/> <line x1="8" x2="21" y1="12" y2="12"/> <line x1="8" x2="21" y1="18" y2="18"/> <line x1="3" x2="3.01" y1="6" y2="6"/> <line x1="3" x2="3.01" y1="12" y2="12"/> <line x1="3" x2="3.01" y1="18" y2="18"/>', False),
    'flatten': ('<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/> <polyline points="7 10 12 15 17 10"/> <line x1="12" x2="12" y1="15" y2="3"/>', False),
    ...
    # Print CTA (Lucide printer).
    'printer': ('<path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/> <path d="M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6"/> <rect width="12" height="8" x="6" y="14" rx="1"/>', False),
    'chevron_up': ('<path d="m18 15-6-6-6 6"/>', False),
}
